...
$(document).ready(function() {
  ...
  $('#fullpage').fullpage({
    'anchors': ['home', 'ux', 'webdesign', 'appdesign'],
    'sectionsColor': ['#28384C', '#ff8d27', '#fff', '#88d3cf'],
    'loopBottom': true,
    ...
    'onSlideLeave': function(anchorLink, index, slideIndex) {
      ...
      if (slideIndex === 1) {
        $('div.phones img:nth-child(1), div.phones img:nth-child(2), div.phones img:nth-child(3), div.ux-headings h1, div.ux-headings h2').removeAttr('style');
      }
